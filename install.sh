#!/usr/bin/env sh
# Universal installer for electionlens. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/electionlens.git"
echo "Installing electionlens ..."
...
echo "Done. Run: electionlens --help"
